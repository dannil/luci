...
return view.extend({
	...
	handle200: function (response, data, firmware) {
	...
	handleError: function (response, data, firmware) {
		...
		let body = [
			...
			E('p', {}, _('Request Data:')),
			E('pre', {}, JSON.stringify({ ...data, ...firmware }, null, 4)),
		];
				...
				switch (response.status) {
					...
					case 200:
						if (main == true) {
							...
							this.handle200(response, data, firmware);
						} else {
